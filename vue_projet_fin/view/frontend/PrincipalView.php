...
<div >
    <div class="col-sm-12 col-md-3 col-lg-3">
        <ul class="nav nav-pills nav-stacked">
            <li class=" active , taille"><a class="colorblanc" href="index.php">Acceuil</a></li>
        </ul>
    </div>
    ...
    <div class="container">
        <div id="content" class=" row">
            ...
            <div class=" bordure padding col-sm-10 col-md-10 col-lg-12">
                <div class="col-sm-4 col-md-4 col-lg-3 ">
                    <a href="index.php?action=getChaps&id=<?=htmlspecialchars($donnees["id"])?>"><img width="185"
                            height="250" src="img/<?=htmlspecialchars($donnees['image'])?> "
                            alt="<?=htmlspecialchars($donnees['titre'])?>"></a>
                </div>
                <div class="col-sm-8  col-md-4 col-lg-8">
                    <p><a
                            href="index.php?action=getChaps&id=<?=htmlspecialchars($donnees["id"])?>"><?=htmlspecialchars($donnees['titre'])?></a>
                    </p>
                    <p><a
                            href="index.php?action=getChaps&id=<?=htmlspecialchars($donnees["id"])?>"><?=htmlspecialchars($donnees['pseudo'])?></a>
                    </p>
